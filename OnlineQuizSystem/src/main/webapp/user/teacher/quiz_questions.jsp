...
<title>Teacher ! Quiz Questions</title>
	...
	<div class="container">
		<div class="row" style="display: flex; justify-content: center">
					...
					<div class="card-footer">
						<div class="container text-center">
							<a href="update_question.jsp?qid=<%=q.getQ_qid() %>"
								...
								href="../admin/admin_deletequestion.jsp?qid=<%=q.getQ_qid() %>&quizid=<%=quizId %>" class="btn btn-sm btn-danger mr-2">Delete</a>
						</div>
					</div>
				</div>
			</div>
			...
			<%
				...
				<a href="teacher_addquestions.jsp" class="btn btn-primary">Add Questions</a>
			</div>
